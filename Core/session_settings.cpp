...
#define SS_PROP_IMPL(type, name) \
    type SessionSettings::name::get() \
    { \
        return settings_->name; \
    } \
    void SessionSettings::name::set(type val) \
    { \
        settings_->name = val; \
    }
...
libtorrent::session_settings& SessionSettings::ptr()
{
    return *settings_;
}
...
System::String^ SessionSettings::user_agent::get()
{
    return interop::from_std_string(settings_->user_agent);
}

void SessionSettings::user_agent::set(System::String^ val)
{
...
System::String^ SessionSettings::announce_ip::get()
{
    return interop::from_std_string(settings_->announce_ip);
}

void SessionSettings::announce_ip::set(System::String^ val)
{
...
System::String^ SessionSettings::handshake_client_version::get()
{
    return interop::from_std_string(settings_->handshake_client_version);
}

void SessionSettings::handshake_client_version::set(System::String^ val)
{
